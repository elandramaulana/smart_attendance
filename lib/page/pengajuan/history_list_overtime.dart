// lib/page/history_list_lembur.dart
...
import 'package:smart_attendance/widget/overtime_list_widget.dart'; // sesuaikan nama widgetmu
...
class HistoryListLembur extends GetView<OvertimeController> {
  ...
  Widget build(BuildContext context) {
    ...
    // pastikan controller sudah di-bind di binding atau gunakan Get.put di sini
    final ctrl = controller;

    // Decoration untuk dropdown
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Gradient background & dekorasi lingkaran
          Container(
          ...
          // Kontainer putih dengan filter + list
          Align(
                        ...
                        Expanded(
                          child: Obx(() => DropdownButtonFormField<String>(
                                ...
                                items: ctrl.months
                                    ...
                                    .toList(),
                                onChanged: (v) => ctrl.selectedMonth.value = v,
                              )),
                        ),
                        SizedBox(width: 12.w),
                        Expanded(
